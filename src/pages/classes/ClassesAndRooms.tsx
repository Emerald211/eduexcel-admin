...
export default function ClassesAndRooms() {
  ...
  const handleCreateRoom = async (e: React.FormEvent) => {
    e.preventDefault();
    try {
      await createRoom({ ...roomForm, schoolId: user?.schoolId || '' }).unwrap();
  ...
  return (
    <div className='classes-rooms-container'>
      <div className='page-header'>
        ...
        <p className='page-subtitle'>Manage your school's classes and facilities</p>
      </div>
      ...
      {activeTab === 'classes' && (
        <div>
          <div className='section-header'>
            ...
            <button onClick={() => setShowClassModal(true)} className='add-button'>
              <Plus size={20} />
              Add New Class
            </button>
          </div>
          ...
          {loadingClasses ? (
            ...
            <div className='empty-state'>
              ...
              <p className='empty-description'>Get started by adding your first class</p>
              <button onClick={() => setShowClassModal(true)} className='empty-action-button'>
                Add Class
              </button>
            </div>
          ) : (
      ...
      {activeTab === 'rooms' && (
        <div>
          <div className='section-header'>
            ...
            <button onClick={() => setShowRoomModal(true)} className='add-button'>
              <Plus size={20} />
              Add New Room
            </button>
          </div>
          ...
          {loadingRooms ? (
            ...
            <div className='empty-state'>
              ...
              <p className='empty-description'>Get started by adding your first room</p>
              <button onClick={() => setShowRoomModal(true)} className='empty-action-button'>
                Add Room
              </button>
            </div>
          ) : (
              ...
              <div className='form-container'>
                ...
                <div className='form-group'>
                  ...
                  <select
                    ...
                    onChange={(e) => setClassForm({ ...classForm, roomAssignmentId: e.target.value || undefined })}
                  ...
                  <p className='form-helper-text'>Assign this class to a specific room</p>
                </div>
                <div className='form-actions'>
                  <button type='button' onClick={closeClassModal} className='form-button cancel'>
                    Cancel
                  </button>
                  <button type='submit' disabled={creatingClass} className='form-button submit'>
                    {creatingClass ? <Loader2 className='spinner' size={20} /> : 'Create Class'}
                  </button>
                </div>
              </div>
            </form>
              ...
              <div className='form-container'>
                ...
                <div className='form-group'>
                  ...
                  <input
                    ...
                    onChange={(e) => setRoomForm({ ...roomForm, capacity: e.target.value ? Number(e.target.value) : undefined })}
                    className='form-input'
                    placeholder='e.g., 30'
                    min='1'
                  />
                ...
                <div className='form-actions'>
                  <button type='button' onClick={closeRoomModal} className='form-button cancel'>
                    Cancel
                  </button>
                  <button type='submit' disabled={creatingRoom} className='form-button submit'>
                    {creatingRoom ? <Loader2 className='spinner' size={20} /> : 'Create Room'}
                  </button>
                </div>
              </div>
            </form>
