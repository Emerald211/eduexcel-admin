...
import {
    ...
    BookOpen,
    Loader2,
    UserCheck, // New icon for Teachers
} from 'lucide-react';
...
export default function ClassDetails() {
    ...
    const teacherDisplay = classData.teacherNames 
        ? classData.teacherNames.split(',').map(name => name.trim()).join(', ') // Format the string
                    ...
                    <div className='details-content'>
                        ...
                        <div className='detail-grid'>
                            ...
                            <div className='detail-item detail-full-width'>
                                <div className='detail-icon'>
                                    <UserCheck size={20} /> {/* Using a slightly different icon for clarity */}
                                </div>
                                <div>
                                    <p className='detail-label'>Assigned Teachers ({teachersCount})</p>
                                    {/* Displaying names clearly or the fallback text */}
                                    <p className='detail-value detail-value-names'>{teacherDisplay}</p>
                                </div>
                            </div>
                        </div>
                    </div>
