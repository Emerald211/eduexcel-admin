...
export default function SubjectDetails() {
	...
	// FIX: Use undefined as the argument for all list queries
	...
	const availableTeachers = useMemo(() => {
		// Teachers list is used to populate the select options
						...
						<form onSubmit={handleAssignment} className='assignment-form'>
							<div className='form-group'>
								...
								<select
									...
									{/* Displaying class name and grade level for clarity */}
									{classes.map((cls) => (
